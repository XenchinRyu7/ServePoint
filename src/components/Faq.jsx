...
export default function Faq() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Kami terintegrasi penuh dengan 15+ POS terpopuler di Indonesia, seperti Moka POS, Pawoon, Olsera, Esensi, Pawoon, Majoo, dan Pawoon Pro. Jika Anda menggunakan sistem POS internal kustom, tim engineering kami siap membuatkan jalur API khusus.'
    },
    {
  ...
  return (
    <section id="faq" class="py-20 md:py-28 bg-white border-b border-slate-200/50">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16 space-y-4">
          ...
          <p class="text-slate-600 font-medium max-w-xl mx-auto text-xs md:text-sm">
            Temukan jawaban cepat seputar teknologi, instalasi, dan integrasi operasional ServePoint di outlet Anda.
          </p>
        </div>
        ...
        <div class="space-y-4 border-t border-slate-200/60 pt-4">
          {faqs.map((faq, index) => {
            ...
            return (
              <div 
                key={index}
                class="border-b border-slate-200/60 pb-4 transition-colors"
              >
                <button
                ...
                >
                  <span class="text-sm md:text-base font-bold text-brand-obsidian group-hover:text-brand-emerald transition-colors">
                    {faq.q}
                  </span>
                  <span class="ml-4 shrink-0 flex items-center justify-center h-7 w-7 rounded-lg bg-slate-50 border border-slate-200 text-slate-500 transition-transform">
                    <svg 
                ...
                {/* Accordion content with clean height transition */}
                <div 
                ...
                >
                  <div class="overflow-hidden">
                    <p class="text-xs md:text-sm text-slate-550 text-slate-500 leading-relaxed font-medium bg-slate-50 p-4 rounded-xl border border-slate-200/40">
                      {faq.a}
                    </p>
                  </div>
                </div>
